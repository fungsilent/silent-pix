...
export function createWorkflowEditorTheme(theme: Theme) {
    return EditorView.theme({
        ...
        '.cm-line.cm-workflow-bound': {
            backgroundColor: 'var(--sp-workflow-bound-soft)',
        },
        '.cm-line.cm-workflow-broken': {
            backgroundColor: 'var(--sp-workflow-broken-soft)',
        },

        '.cm-workflow-node-id': { color: 'var(--sp-accent-fg)' },
        '.cm-workflow-key': { color: 'var(--sp-fg)' },
        '.cm-workflow-string': { color: 'var(--sp-code-string)' },
        '.cm-workflow-number': { color: 'var(--sp-code-number)' },
        '.cm-workflow-literal': { color: 'var(--sp-code-literal)' },
