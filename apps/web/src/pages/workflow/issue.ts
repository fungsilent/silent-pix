...
const graphFailureMessage: Record<WorkflowApi.ParseApiGraphFailure, string> = {
...
const mappingIssueMessage: Record<WorkflowApi.MappingIssueReason, (issue: WorkflowApi.MappingIssue) => string> = {
...
export function toMappingIssues(issues: WorkflowApi.MappingIssue[]): AppIssue[] {
