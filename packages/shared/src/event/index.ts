...
export const serverEvent = z.discriminatedUnion('type', [taskCreated, taskChanged, taskRemoved, healthSnapshot])
export type ServerEvent = TaskCreated | TaskChanged | TaskRemoved | HealthSnapshot
