...
INSERT INTO `__new_tasks`("id", "name", "status", "workflow_id", "config", "workflow_revision", "created_at", "updated_at", "comfy_prompt_id", "error_code", "error_message") SELECT "id", "name", "status", "workflow_id", "config", "workflow_revision", "created_at", "updated_at", "comfy_prompt_id", "error_code", "error_message" FROM `tasks`;--> statement-breakpoint
